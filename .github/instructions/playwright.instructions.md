...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, non-obvious interactions, or test-environment constraints; never narrate the assertion or restate the locator.
...
- [ ] Code follows the repository formatting rules and comments explain intent rather than restating test code
